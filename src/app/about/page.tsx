      ...
      <main className="relative min-h-screen w-full bg-[#020617] font-inter relative overflow-hidden" ref={heroRef}>
        ...
        <section className="w-full flex justify-center items-center py-20 px-2">
          <div className="w-full max-w-7xl flex flex-col items-center">
            {/* Section Title */}
            <button className="mb-16 px-8 py-3 rounded-xl bg-gradient-to-br from-[#232c3b] to-[#1e274b] text-blue-100 font-normal text-2xl shadow-lg border-none relative overflow-hidden transition-all duration-300 hover:scale-105 hover:shadow-blue-500/40 hover:bg-blue-900/30">
              Our Philosophy
            </button>
            {/* Philosophy Items */}
            <div className="w-full grid grid-cols-1 md:grid-cols-3 gap-12">
              {[1,2,3].map((_,i) => (
                <div key={i} className="flex flex-col items-center text-center transition-all duration-300 hover:scale-105 hover:shadow-blue-500/40 hover:bg-blue-900/30">
        ...
        <section className="w-full flex justify-center items-center py-20 px-2">
          <div className="w-full max-w-7xl flex flex-col items-center">
            ...
            <div className="w-full grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
              {/* Card 1 */}
              <div className="relative flex flex-col items-center text-center bg-gradient-to-br from-[#232c3b]/60 to-[#151a2e]/60 rounded-2xl p-8 shadow-xl min-h-[300px] transition-all duration-300 hover:scale-105 hover:shadow-blue-500/40 hover:bg-blue-900/30">
        ...
        <section className="w-full flex justify-center items-center py-16 px-2">
          <div className="w-full  flex flex-col items-center">
            {/* Section Title */}
            <button className="mb-12 px-8 py-3 rounded-xl bg-gradient-to-br from-[#232c3b] to-[#1e274b] text-blue-100 font-normal text-2xl shadow-lg border-none relative overflow-hidden transition-all duration-300 hover:scale-105 hover:shadow-blue-500/40 hover:bg-blue-900/30">
              Our Clients
            </button>
            {/* Clients Logos Row */}
